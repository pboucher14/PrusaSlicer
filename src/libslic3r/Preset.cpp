...
const std::vector<std::string>& Preset::filament_options()
{
    static std::vector<std::string> s_opts {
        ...
        "extrusion_multiplier", "filament_density", "filament_cost", "filament_spool_weight", "filament_z_offset", "filament_loading_speed", "filament_loading_speed_start", "filament_load_time",
